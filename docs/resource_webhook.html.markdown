...
* `events` - (Required, list of strings) one of	`	"contract_changed_event", "contract_published", "provider_verification_published",` (see [Webhooks](http://docs.pact.io/pact_broker/advanced_topics/webhooks/) for more on this).
